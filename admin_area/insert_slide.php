    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Main Crystal
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Insert Main Crystal
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if($count<1){
            ...
            $insert_slide = "insert into main (crystal_img) values ('$slide_image')";
           ...
           echo "<script>alert('You have already inserted 1 Image. There can only be 1 image.')</script>"; 
