<?php 
    ...
    if(!isset($_SESSION['admin_email'])){
        ...
        if($_SESSION['admin_email']=="developer@tresmind.com"){  
?>
...
if(isset($_POST['update'])){
    ...
    $update_user = "update admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_contact='$user_contact',admin_job='$user_job',admin_image='$user_image' where admin_id='$user_id'";
...
<?php } else {echo "<script>alert('Permission denied!!')</script>";
