...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_contact,admin_job,admin_image) values ('$user_name','$user_email','$user_pass','$user_contact','$user_job','$user_image')";
